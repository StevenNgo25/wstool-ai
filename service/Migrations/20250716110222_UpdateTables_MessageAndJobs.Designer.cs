...
namespace WhatsAppCampaignManager.Migrations
{
    ...
    [Migration("20250716110222_UpdateTables_MessageAndJobs")]
    partial class UpdateTables_MessageAndJobs
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("WhatsAppCampaignManager.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedAt = new DateTime(2025, 7, 16, 11, 2, 21, 361, DateTimeKind.Utc).AddTicks(3704),
                            Email = "admin@whatsappcampaign.com",
                            IsActive = true,
                            PasswordHash = "$2a$11$vjal.naaLBMQzFLxYD5BUuV0/PPJy2mh1E6F1RNiTNWqEY6l28Q56",
                            Role = "Admin",
                            Username = "admin"
                        },
                        new
                        {
                            Id = 2,
                            CreatedAt = new DateTime(2025, 7, 16, 11, 2, 21, 472, DateTimeKind.Utc).AddTicks(5881),
                            Email = "user1@whatsappcampaign.com",
                            IsActive = true,
                            PasswordHash = "$2a$11$qMX7euQc8/aOu7fkvplGHOUsQjgJON2WK0XU0vM/lsaXGXAWCD7za",
                            Role = "Member",
                            Username = "user1"
                        });
                });
